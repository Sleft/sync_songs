...
- Rename attribute title of Song to name to conform with libs.
- Add ending punctuation (.) to paramter documentation.
- Add tests for =Song#similar?= and =Song#include?= and =Song#to_search_term=.

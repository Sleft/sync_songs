...
* TODO Plan
- Use =yield= to ship out info for all methods that has a verbose mode.
- The attribute =album= is not needed in SongList?
- Add the method =clear= to SongList.
...
- Text user interface:
  ...
  4. Show how many favorites got from either service.
